(function() {
  ...
  function initPeer() {
    ...
    let iceServers = '[]';
    try {
      iceServers = JSON.parse(coplayOptions.iceServers);
    } catch(e) {
      alert("invalid ice server list config " + e);
      return;
    }
    if (iceServers.length == 0) {
      console.log("Use default ice servers.");
      iceServers = [
    ...
    console.log("ice server list: ", iceServers);
    let peerOptions = {
